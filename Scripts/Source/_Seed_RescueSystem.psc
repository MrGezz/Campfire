scriptname _Seed_RescueSystem extends _Seed_BaseSystem
...
Book property _Seed_RobLetterSettlement_Riverwood auto
Book property _Seed_RobLetterSettlement_Rorikstead auto
Book property _Seed_RobLetterSettlement_Kynesgrove auto
Book property _Seed_RobLetterSettlement_DragonBridge auto
Book property _Seed_RobLetterSettlement_Ivarstead auto
Book property _Seed_RobLetterSettlement_NightgateInn auto
Book property _Seed_RobLetterSettlement_Winterhold auto
Book property _Seed_RobLetterSettlement_Windhelm auto
Book property _Seed_RobLetterSettlement_Solitude auto
Book property _Seed_RobLetterSettlement_Markarth auto
Book property _Seed_RobLetterSettlement_Whiterun auto
Book property _Seed_RobLetterSettlement_Riften auto
Book property _Seed_RobLetterSettlement_Falkreath auto
Book property _Seed_RobLetterSettlement_Morthal auto
Book property _Seed_RobLetterSettlement_Dawnstar auto
Book property _Seed_RobLetterOther auto
Book property _Seed_RescueLetterSettlement auto
Book property _Seed_RescueLetterSpouse auto
Message property _Seed_RescueMsg_LastSleepLocation auto
Message property _Seed_RescueMsg_Failsafe auto
Message property _Seed_RescueMsg_A_1 auto
Message property _Seed_RescueMsg_A_2 auto
Message property _Seed_RescueMsg_F_1 auto
Message property _Seed_RescueMsg_F_2 auto
Message property _Seed_RescueMsg_F_3 auto
Message property _Seed_RescueMsg_F_4 auto
Message property _Seed_RescueMsg_F_5 auto
Message property _Seed_RescueMsg_D_1 auto
Message property _Seed_RescueMsg_D_2 auto
Message property _Seed_RescueMsg_D_3 auto
Message property _Seed_RescueMsg_D_4 auto
MiscObject property Gold001 auto
ReferenceAlias property Alias_LoveInterest auto
FormList property _Camp_Trees auto
ObjectReference property _Seed_LastSleepMarker auto
ObjectReference property _Seed_RescueDestinationMarker auto
ObjectReference property _Seed_MarkerTamriel auto
ObjectReference property _Seed_MarkerRiverwood auto
ObjectReference property _Seed_MarkerRorikstead auto
ObjectReference property _Seed_MarkerKynesgrove auto
ObjectReference property _Seed_MarkerDragonbridge auto
ObjectReference property _Seed_MarkerIvarstead auto
ObjectReference property _Seed_MarkerNightgateInn auto
ObjectReference property _Seed_MarkerWinterhold auto
ObjectReference property _Seed_MarkerWindhelm auto
ObjectReference property _Seed_MarkerSolitude auto
ObjectReference property _Seed_MarkerMarkarth auto
ObjectReference property _Seed_MarkerWhiterun auto
ObjectReference property _Seed_MarkerRiften auto
ObjectReference property _Seed_MarkerFalkreath auto
ObjectReference property _Seed_MarkerMorthal auto
ObjectReference property _Seed_MarkerDawnstar auto
...
bool lastSleepMarkerReady = false
...
function OnSleepStart(Float afSleepStartTime, Float afDesiredSleepEndTime)
	if GetDiseaseSystem().getLocationHazardLevel() <= 2
		lastSleepMarkerReady = true
		_Seed_LastSleepMarker.MoveTo(PlayerRef as ObjectReference, abMatchRotation = true)
	endIf
endFunction

function RegisterForEvents()
	GetEventEmitter_OnRescuePlayer().RegisterFormForModEventWithFallback("Seed_OnRescuePlayer", "OnRescuePlayer", self)
endFunction
	...
	if GetTrackedFollowerCount() > 0
		...
		if !will_build_fire
			if PlayerRef.GetWorldspace() == Tamriel
				...
				if IsUpToAndBetween(rescueDestinationIndex, 100, 199)
					RescueFollowerTakenToOther()
				elseif IsUpToAndBetween(rescueDestinationIndex, 200, 299)
					RescueFollowerPasserby()
				elseif IsUpToAndBetween(rescueDestinationIndex, 300, 399)
					RescueFollowerHunterCamp()
				elseif IsUpToAndBetween(rescueDestinationIndex, 400, 599)
					RescueFollowerTakenToNearestSettlement()
				endif
			elseif PlayerRef.GetWorldspace() == DLC01FalmerValley
				RescueMovePlayerAndFollowers(none, 14107, 19076, 1924, 20.77)
			elseif PlayerRef.GetWorldspace() == DLC2SolstheimWorld
				FindNearestSettlementDLC2()
				GoToNearestSettlementDLC2()
				;@TODO: message
			else
				GoToLastSafeSleepLocation()
			endif
		else
		...
		if PlayerRef.GetWorldspace() == Tamriel
			...
			;Decide random fate
				...
				if Alias_LoveInterest.GetActorRef() != none
					int i = RandomInt(1, 100)
					if IsUpToAndBetween(i, 1, 25)
						RescueAloneTakenToDistantSettlement()
					elseif IsUpToAndBetween(i, 26, 50)
						RescueAloneTakenToDistantSettlementAndRobbed()
					elseif IsUpToAndBetween(i, 51, 75)
						RescueAloneTakenHomeToSpouse()
					elseif IsUpToAndBetween(i , 76, 100)
						RescueAloneTakenToOtherAndRobbed()
					endif
				else
					int i = RandomInt(1, 100)
					if IsUpToAndBetween(i, 1, 33)
						RescueAloneTakenToDistantSettlement()
					elseif IsUpToAndBetween(i, 34, 66)
						RescueAloneTakenToDistantSettlementAndRobbed()
					elseif IsUpToAndBetween(i , 67, 100)
						RescueAloneTakenToOtherAndRobbed()
					endif
				endif
			endif
...
function RescueStart(bool bInWater = false)
	...
	restoreAttributesAfterRescue()
endFunction

function restoreAttributesAfterRescue()
	SeedDebug(0, "[Rescue System]: Restoring Attributes.")
	SeedDebug(0, "[Rescue System]: Vitality Amount: " + GetPlayerVitality())
	SeedDebug(0, "[Rescue System]: Hunger Amount: " + GetPlayerHunger())
	SeedDebug(0, "[Rescue System]: Hunger Amount: " + GetPlayerHunger())
	SeedDebug(0, "[Rescue System]: Thirst Amount: " + GetPlayerThirst())
	SeedDebug(0, "[Rescue System]: Fatigue Amount: " + GetPlayerFatigue())
	
	
	GetVitalitySystem().SetAttribute(45.0)
	if(GetPlayerHunger() > 90.0)
		GetHungerSystem().setAttribute(90.0)
	endif
	if(GetPlayerThirst() > 90.0)
		GetThirstSystem().setAttribute(90.0)
	endif
	if(GetPlayerFatigue() > 90.0)
		GetFatigueSystem().setAttribute(90.0)
	endif
	if SeedUtil.GetCompatibilitySystem().isFrostfallLoaded
		if frostUtil.GetPlayerExposure() > 45.0
			frostUtil.GetExposureSystem().SetExposure(45.0, true)
		endif
		frostUtil.GetWetnessSystem().SetWetness(0.0, true)
	endif
endFunction
...
function RescueMovePlayerAndFollowers(ObjectReference akDestinationObject, float x = 0.0, float y = 0.0, float z = 0.0, float az = 0.0)
	if akDestinationObject != none
		_Seed_RescueDestinationMarker.MoveTo(akDestinationObject, abMatchRotation = true)
	else
		_Seed_RescueDestinationMarker.MoveTo(PlayerRef)
	endif
	if x != 0.0 && y != 0.0 && z != 0.0 && az != 0.0
		_Seed_RescueDestinationMarker.SetPosition(x, y, z)
		_Seed_RescueDestinationMarker.SetAngle(0.0, 0.0, az)
	endif
	if follower1 && follower1.GetDistance(PlayerRef) <= 2000.0
		follower1.MoveTo(_Seed_RescueDestinationMarker)
	endif
	if follower2 && follower2.GetDistance(PlayerRef) <= 2000.0
		follower2.MoveTo(_Seed_RescueDestinationMarker)
	endif
	if follower3 && follower3.GetDistance(PlayerRef) <= 2000.0
		follower3.MoveTo(_Seed_RescueDestinationMarker)
	endif
	if animal && animal.GetDistance(PlayerRef) <= 2000.0
		animal.MoveTo(_Seed_RescueDestinationMarker)
	endif
	PlayerRef.MoveTo(_Seed_RescueDestinationMarker, abMatchRotation = true)
endFunction
...
Function GoToLastSafeSleepLocation()
	if lastSleepMarkerReady
		RescueMovePlayerAndFollowers(_Seed_LastSleepMarker)
		rescueDestinationIndex = 0
		_Seed_RescueMsg_LastSleepLocation.Show()
	else
		;Failsafe!
...
function GoToRandomSettlement()	
	...
	if i == 1 				;VILLAGE Riverwood
		RescueMovePlayerAndFollowers(_Seed_MarkerRiverwood)
		rescueDestinationIndex = 400
	elseif i == 2			;VILLAGE Rorikstead
		RescueMovePlayerAndFollowers(_Seed_MarkerRorikstead)
		rescueDestinationIndex = 402
	elseif i == 3			;VILLAGE Kynesgrove
		RescueMovePlayerAndFollowers(_Seed_MarkerKynesgrove)
		rescueDestinationIndex = 403
	elseif i == 4			;VILLAGE Dragon Bridge
		RescueMovePlayerAndFollowers(_Seed_MarkerDragonbridge)
		rescueDestinationIndex = 404
	elseif i == 5			;VILLAGE Ivarstead
		RescueMovePlayerAndFollowers(_Seed_MarkerIvarstead)
		rescueDestinationIndex = 405
	elseif i == 6			;VILLAGE Nightgate Inn
		RescueMovePlayerAndFollowers(_Seed_MarkerNightgateInn)
		rescueDestinationIndex = 406
	elseif i == 7			;CITY Winterhold
		RescueMovePlayerAndFollowers(_Seed_MarkerWinterhold)
		rescueDestinationIndex = 500
	elseif i == 8			;CITY Windhelm
		RescueMovePlayerAndFollowers(_Seed_MarkerWindhelm)
		rescueDestinationIndex = 501
	elseif i == 9			;CITY Solitude
		RescueMovePlayerAndFollowers(_Seed_MarkerSolitude)
		rescueDestinationIndex = 502
	elseif i == 10			;CITY Markarth
		RescueMovePlayerAndFollowers(_Seed_MarkerMarkarth)
		rescueDestinationIndex = 503
	elseif i == 11			;CITY Whiterun
		RescueMovePlayerAndFollowers(_Seed_MarkerWhiterun)
		rescueDestinationIndex = 504
	elseif i == 12			;CITY Riften
		RescueMovePlayerAndFollowers(_Seed_MarkerRiften)
		rescueDestinationIndex = 505
	elseif i == 13			;CITY Falkreath
		RescueMovePlayerAndFollowers(_Seed_MarkerFalkreath)
		rescueDestinationIndex = 506
	elseif i == 14			;CITY Morthal
		RescueMovePlayerAndFollowers(_Seed_MarkerMorthal)
		rescueDestinationIndex = 507
	elseif i == 15			;CITY Dawnstar
		RescueMovePlayerAndFollowers(_Seed_MarkerDawnstar)
		rescueDestinationIndex = 508
	endif
endFunction
function GoToNearestPasserby()	
	if rescueDestinationIndex == 200
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, -6949.0, 65466.22, -11584.55, 186.45)		;NPCs
	elseif rescueDestinationIndex == 201
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, -25965.32, -105386.63, 12612.95, 330.95)	;NPC
	elseif rescueDestinationIndex == 202
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 118200.54, -81600.09, 11014.21, 256.17)		;NPCs
	elseif rescueDestinationIndex == 203
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 196353.59, -117115.1, 13223.43, 98.68)  	;Stendarr's Beacon
	elseif rescueDestinationIndex == 204
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 102442.45, -57511.14, 11076.83, 309.25)		;Guards
	elseif rescueDestinationIndex == 205
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 122056.44, -35001.86, -9936.53, 200.32)		;NPCs
	elseif rescueDestinationIndex == 206
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 71056.38, 57366.27, -3928.56, 5.29)			;NPCs
...
function GoToNearestOther()		
	if rescueDestinationIndex == 101
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 140737.09, 106343.84, -13651.3, 254.32)
	;elseif rescueDestinationIndex == 102
		;RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 51273.34, 122487.61, -13904.53, 250.15) 	; bad location
	elseif rescueDestinationIndex == 103
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 114249.54, -97344.74, 13451.41, 292.74)
	elseif rescueDestinationIndex == 104
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 3870.03, -788875.62, 4329.36, 13.5)
	elseif rescueDestinationIndex == 105
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, -67879.52, 142212.31, -13953.21, 6.74)
	elseif rescueDestinationIndex == 106
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, -153431.19, 111832.77, -13880.53, 313.48)
	elseif rescueDestinationIndex == 107
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 168690.56, -51559.07, 5640.32, 16.87)
	elseif rescueDestinationIndex == 108
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 146606.0, -82556.13, -13549.97, 17.79)
	elseif rescueDestinationIndex == 109
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 105746.59, 31246.81, -10390.98, 256.48)
	elseif rescueDestinationIndex == 110
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 83640.48, 110224.12, -13467.42, 83.2)
	elseif rescueDestinationIndex == 111
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 25871.0, 46301.0, -5013.67, 181.87)
	elseif rescueDestinationIndex == 112
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, -73657.84, 90966.23, -13923.84, 60.71)
	endif
endFunction
...
function GiveRandomSettlementNote(bool Robbed = false)
	if Robbed == false
		PlayerRef.AddItem(_Seed_RescueLetterSettlement)
	else
		if rescueDestinationIndex == 400 																;VILLAGE Riverwood
			PlayerRef.AddItem(_Seed_RobLetterSettlement_Riverwood)
		elseif rescueDestinationIndex == 402															;VILLAGE Rorikstead
			PlayerRef.AddItem(_Seed_RobLetterSettlement_Rorikstead)
		elseif rescueDestinationIndex == 403															;VILLAGE Kynesgrove
			PlayerRef.AddItem(_Seed_RobLetterSettlement_Kynesgrove)
		elseif rescueDestinationIndex == 404															;VILLAGE Dragon Bridge
			PlayerRef.AddItem(_Seed_RobLetterSettlement_DragonBridge)
		elseif rescueDestinationIndex == 405															;VILLAGE Ivarstead
			PlayerRef.AddItem(_Seed_RobLetterSettlement_Ivarstead)
		elseif rescueDestinationIndex == 406															;VILLAGE Nightgate Inn
			PlayerRef.AddItem(_Seed_RobLetterSettlement_NightgateInn)
		elseif rescueDestinationIndex == 500															;CITY Winterhold
			PlayerRef.AddItem(_Seed_RobLetterSettlement_Winterhold)
		elseif rescueDestinationIndex == 501															;CITY Windhelm
			PlayerRef.AddItem(_Seed_RobLetterSettlement_Windhelm)
		elseif rescueDestinationIndex == 502															;CITY Solitude
			PlayerRef.AddItem(_Seed_RobLetterSettlement_Solitude)
		elseif rescueDestinationIndex == 503															;CITY Markarth
			PlayerRef.AddItem(_Seed_RobLetterSettlement_Markarth)
		elseif rescueDestinationIndex == 504															;CITY Whiterun
			PlayerRef.AddItem(_Seed_RobLetterSettlement_Whiterun)
		elseif rescueDestinationIndex == 505															;CITY Riften
			PlayerRef.AddItem(_Seed_RobLetterSettlement_Riften)
		elseif rescueDestinationIndex == 506															;CITY Falkreath
			PlayerRef.AddItem(_Seed_RobLetterSettlement_Falkreath)
		elseif rescueDestinationIndex == 507															;CITY Morthal
			PlayerRef.AddItem(_Seed_RobLetterSettlement_Morthal)
		elseif rescueDestinationIndex == 508															;CITY Dawnstar
			PlayerRef.AddItem(_Seed_RobLetterSettlement_Dawnstar)
		endif
	endif
endFunction
...
function GoToNearestHunterCamp()
	if rescueDestinationIndex == 300
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, -64154.67, -39697.98, -1086.85, 335.15)
	elseif rescueDestinationIndex == 301
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 185655.47, -37709.24, 5770.93, 296.40)
	elseif rescueDestinationIndex == 302
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 113070.53, -25050.97, -10087.63, 0.17)
	elseif rescueDestinationIndex == 303
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 35403.59, 84115.66, -8072.59, 197.71)
	elseif rescueDestinationIndex == 304
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, -20098.11, -62001.73, 636.08, 124.64)
	elseif rescueDestinationIndex == 305
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, -56964.62, -55207.97, 1494.54, 48.39)
	elseif rescueDestinationIndex == 306
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, -15489.56, 26036.83, -1273.99, 4.46)
	elseif rescueDestinationIndex == 307
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, -47067.44, 43420.13, -6086.28, 317.61)
	elseif rescueDestinationIndex == 308
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 150894.58, -9137.76, -9304.45, 313.79)
	elseif rescueDestinationIndex == 309
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 158177.19, -83535.55, 11018.53, 135.77)
	elseif rescueDestinationIndex == 310
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, -278.40, -60866.98, 614.83, 289.62)
	elseif rescueDestinationIndex == 311
		RescueMovePlayerAndFollowers(_Seed_MarkerTamriel, 153947.91, 17389.73, -4720.31, 174.08)
	endif
endFunction
function RobPlayer()
...
function RescueAloneHunterCamp()
	...
	_Seed_RescueMsg_A_1.Show()
endFunction
function RescueAlonePasserby()	
	GoToNearestPasserby()
	_Seed_RescueMsg_A_2.Show()
endFunction
